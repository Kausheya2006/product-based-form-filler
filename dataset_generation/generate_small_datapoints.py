...
CONVERSATIONS_PATH = os.path.join(DATA_DIR, "generated_small_conversations.json")
...
### CONVERSATION (SHORT - max 10 words per line)
{conversation}
...
def generate_small_datapoints():
    ...
    print(f"Total small conversations: {total_convos}. Already processed: {len(processed_convos)}")
